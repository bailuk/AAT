...
public class AppThemeLight {
    ...
    public static void themify(CheckBox b) {
        b.setBackgroundColor(getBackgroundColor());
    ...
    public static void themify(Button w) {
        w.setBackgroundColor(getBackgroundColor());
        //w.setBackgroundResource(R.drawable.button);
        w.setTextColor(getTextColor());
        w.setTextSize(getTextColor());
    }
