...
public class Configuration{
    ...
    public final static String mapsForgeVersion = "0.20.0";
    public final static String appVersionName = "v1.24";
    public final static String appVersionCode = "37";
    public final static String focVersion = "1.3";
    public final static String appCopyright = "© 2011-2024 Lukas Bai, GNU GPLv3 or later\n© Map and data OSM contributors ODbL 1.0";
